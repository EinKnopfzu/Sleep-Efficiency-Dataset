...
\textbr {- expressiv: Expresivität bedeutet, dass die Daten unverfälscht wiedergegeben werden. Grundsätzlich sollen nur die Informationen dargestellt werden, die auch im Datenamterial vorhanden sind.\\
...
\textbr {Aufgabenstellung: Analyse der Variablen und den Einfuss den }
