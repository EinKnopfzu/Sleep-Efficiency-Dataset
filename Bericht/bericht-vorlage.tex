...
Die Visualisierung ist als One Page Application konzipiert, dies ist Aufhrund der benötigten Interaktion mit den Filtern un dWahl der Attribute nützlich.
Das Main.elm ruft
...
\begin{figure}[h]
  \centering
  \includegraphics [width = 0.8\textwidth]{Bsp_QQ-Plot.PNG}
