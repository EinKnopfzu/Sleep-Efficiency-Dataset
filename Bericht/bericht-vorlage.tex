...
Bei der Normalitätsüberprüfung, der primäre Zweck eines QQ-Plots, geht es darum zu überprüfen ob ein Attribut  einer Normalverteilung folgt. Ein perfekter QQ-Plot würde alle Punkte auf der Linie der Gleichverteilung platzieren. Abweichungen von dieser Linie können auf Abweichungen von der Normalverteilung hindeuten. Der Anwender muss in der Visualisierung sehen kann anhand der roten Linie die vom 25 Quantil bis zum 75 Quantil gezogen wird. Lässt den Anwender überprüfen ob die Daten der noralverteilung folgen 

    Identifikation von Abweichungen:
        Ein QQ-Plot ermöglicht es, visuell Abweichungen von der Normalverteilung zu identifizieren. Beispielsweise können Schwanzschwerpunkte oder Spitzen auf nicht-normale Verteilungen oder Ausreißer hinweisen.

    Bestätigung von Normalverteilung:
        Wenn die Punkte im QQ-Plot gut auf der Linie der Gleichverteilung liegen, deutet dies darauf hin, dass die Stichprobe wahrscheinlich einer Normalverteilung folgt. Dies ist wichtig für viele statistische Tests, die die Annahme einer normalen Verteilung voraussetzen.

    Vergleich verschiedener Verteilungen:
        QQ-Plots können nicht nur für die Überprüfung der Normalverteilung, sondern auch für den Vergleich mit anderen theoretischen Verteilungen verwendet werden. Dies ermöglicht es, die Eignung verschiedener Verteilungen für die Beschreibung von Daten zu beurteilen.

    Identifikation von Ausreißern:
        Ausreißer können im QQ-Plot leicht identifiziert werden, da sie als Punkte abseits der erwarteten Linie erscheinen. Dies ist besonders wichtig, wenn man Ausreißer in den Daten untersuchen oder eliminieren möchte. 

\begin{figure}[H]
  \centering
  \includegraphics*{NormQQPlott}
