...
\begin{figure}[h]
  \centering
  \includegraphics*{NormQQPlott.JPG}
...
Der Benutzer kann in der Visualisierung zwei weitere Attribute auswählen. Diese werden in gleicher Form als QQ-Plott dargestellt und ermöglichen eine schnelle Einschätzung der Güte. 
...
Ein Histogramm würd ezu einem ähnlichem mentalem Modell führen, allerdings würde dieses.
\\
